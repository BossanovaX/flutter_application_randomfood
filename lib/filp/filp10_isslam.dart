...
class Filp10Isslam extends StatefulWidget {
  @override
  _CardFlipDemoState createState() => _CardFlipDemoState();
}

class _CardFlipDemoState extends State<Filp10Isslam>
  ...
  Future<void> _fetchBreakfastMenus() async {
    final List<Map<String, dynamic>> maps =
        await _dbHelper.getfoodbytype3('อิสลาม'); // ใส่ type อาหารลงไป
  ...
  Widget _buildTextItem(int index) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: Color.fromARGB(255, 255, 243, 229), // ใช้โทนสีส้มอ่อน
        ...
        children: [
          Text(
            ...
            style: TextStyle(
              ...
              color: Color.fromARGB(255, 95, 88, 80),
            ),
