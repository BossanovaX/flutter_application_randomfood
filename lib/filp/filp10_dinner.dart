...
class Filp10Dinner extends StatefulWidget {
  @override
  _CardFlipDemoState createState() => _CardFlipDemoState();
}

class _CardFlipDemoState extends State<Filp10Dinner>
  ...
  Future<void> _fetchBreakfastMenus() async {
    final List<Map<String, dynamic>> maps =
        await _dbHelper.getfoodbytype('อาหารเย็น'); // ใส่ type อาหารลงไป
  ...
  Widget _buildTextItem(int index) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: Colors.orange.shade100, // ใช้โทนสีส้มอ่อน
