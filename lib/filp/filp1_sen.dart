...
class Filp1Sen extends StatefulWidget {
  @override
  _CardFlipDemoState createState() => _CardFlipDemoState();
}

class _CardFlipDemoState extends State<Filp1Sen> with TickerProviderStateMixin {
  ...
  Future<void> _fetchBreakfastMenus() async {
    final List<Map<String, dynamic>> maps =
        await _dbHelper.getfoodbytype2('เส้น'); // ใส่ type อาหารลงไป
  ...
  Widget _buildTextItem(int index) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: Color.fromARGB(255, 243, 220, 193), // ใช้โทนสีส้มอ่อน
