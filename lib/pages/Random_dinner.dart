...
import 'package:flutter_application_randomfood/filp/filp10_dinner.dart';
import 'package:flutter_application_randomfood/filp/filp1_dinner.dart';
...
class dinner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('เมนูสุ่มอาหารเย็น', style: TextStyle(fontSize: 24)),
        centerTitle: true,
        backgroundColor: Color.fromARGB(255, 252, 186, 45),
      ),
      body: Container(
...
class _MenuCardState extends State<MenuCard> {
  ...
  Future<void> getitem() async {
    final itemlist = await _dbhelper.getfoodbytype('อาหารเย็น');
    setState(() {
      _item = itemlist;
    });
  }
