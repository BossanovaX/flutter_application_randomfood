...
import 'package:flutter_application_randomfood/filp/filp10_kubkao.dart';
import 'package:flutter_application_randomfood/filp/filp1_kubkao.dart';

import 'package:flutter_application_randomfood/services/database_service.dart';

class RandomKubkhao extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title:
            Text('เมนูสุ่มอาหารประเภทกับข้าว', style: TextStyle(fontSize: 24)),
        centerTitle: true,
...
class _MenuCardState extends State<MenuCard> {
  ...
  Future<void> getitem() async {
    final itemlist = await _dbhelper.getfoodbytype2('กับข้าว');
    setState(() {
      _item = itemlist;
    });
  }
                ...
                child: Container(
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: AssetImage("assets/images/kubkao.jpg"),
                      fit: BoxFit.cover,
                    ),
                    boxShadow: [
                      BoxShadow(
