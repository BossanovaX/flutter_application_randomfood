...
import 'package:flutter_application_randomfood/filp/filp10_desert.dart';
import 'package:flutter_application_randomfood/filp/filp1_desert.dart';
...
class desert extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title:
            Text('เมนูสุ่มอาหารประเภทของหวาน', style: TextStyle(fontSize: 24)),
        centerTitle: true,
...
class _MenuCardState extends State<MenuCard> {
  ...
  Future<void> getitem() async {
    final itemlist = await _dbhelper.getfoodbytype2('ของหวาน');
    setState(() {
      _item = itemlist;
    });
  }
